...
@section('content')
     <div class="owl-carousel owl-carousel1 owl-carousel-fullwidth fh5co-light-arrow animate-box" data-animate-effect="fadeIn">
            <div class="item"><a href="/assets/images/img_large_1.jpg" class="image-popup"><img src="{{ URL::to('/') }}/assets/images/img_large_1.jpg" alt="image"></a></div>
            <div class="item"><a href="/assets/images/img_large_2.jpg" class="image-popup"><img src="{{ URL::to('/') }}/assets/images/img_large_2.jpg" alt="image"></a></div>
            <div class="item"><a href="/assets/images/img_large_3.jpg" class="image-popup"><img src="{{ URL::to('/') }}/assets/images/img_large_3.jpg" alt="image"></a></div>
            <div class="item"><a href="/assets/images/img_large_4.jpg" class="image-popup"><img src="{{ URL::to('/') }}/assets/images/img_large_4.jpg" alt="image"></a></div>
            <div class="item"><a href="/assets/images/img_large_5.jpg" class="image-popup"><img src="{{ URL::to('/') }}/assets/images/img_large_5.jpg" alt="image"></a></div>
        </div>
